...
@section('subcontent')
    <div class="intro-y mt-5 flex items-center justify-between">
        <div class="flex items-center text-lg font-medium uppercase">
            {!! $icons['chevron-right'] !!} Danh Sách Loại Công Trình
        </div>
        <a class="flex items-center text-primary" href="{{ route('view-type-of-construction') }}">
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
       ...
       <div class="intro-y col-span-12 overflow-auto lg:overflow-x-auto">
        @auth
        <form action="{{ route('delete-multiple-type-of-construction') }}" method="POST" id="delete-multiple-form">
            @csrf
            @method('DELETE')
