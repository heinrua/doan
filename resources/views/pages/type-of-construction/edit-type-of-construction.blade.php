...
@section('subcontent')
    ...
    <div class="mt-5 grid grid-cols-1 gap-x-6 pb-20"> {{-- Chỉnh thành grid-cols-1 để tối ưu mobile --}}
        <div class="intro-y">
            <form enctype="multipart/form-data" class="validate-form" action="{{ route('update-type-of-construction') }}"
                method="post">
                ...
                <div class="intro-y box mt-5 p-5">
                    <div class="rounded-md border border-slate-200/60 p-5">
                        <div
                            ...
                            {!! $icons['chevron-down'] !!} Thông Tin Loại Công Trình
                        </div>
                        <div class="mt-5">
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <label class="md:w-64">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Tên Loại Công Trình</div>
                                ...
                                <div class="w-full">
                                    <input name="name" id="name" type="text"
                                        placeholder="Tên Loại Công Trình" value="{{ $construction->name }}" />
                            ...
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <div class="w-full">
                                    <input name="description" id="description" type="text"
                                        placeholder="Mô Tả" value="{{ $construction->description }}" />
                                    <x-base.form-help class="text-right"> Tối thiểu 5 ký tự </x-base.form-help>
                                </div>
                            </div>
                        </div>
