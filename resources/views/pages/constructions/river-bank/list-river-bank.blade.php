...
@section('subcontent')
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 flex flex-wrap items-start gap-3">
            <form action="{{ route('view-construction-river-bank') }}" method="GET"
                ...
                <select id="communeSelect" name="commune_id"
                        data-selected="{{ request('commune_id') }}"
                        class="h-10 w-40 min-w-[100px] border-gray-500 rounded-md shadow-sm focus:ring-blue-500">
            ...
            @auth
                ...
                <a href="{{ route('export-river-bank-construction') }}">
                ...
                <button type="button" onclick="openUploadModal('{{ route('import-river-bank-construction') }}')" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 flex items-center gap-2">
                    {!! $icons['cloud-upload'] !!} Nhập file
                </button>
                <a href="{{ asset('downloads/mau-du-lieu-cong-trinh-sat-lo.xlsx') }}" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" download>
                    Tải file mẫu
                </a>
            @endauth
        </div>
        ...
        <div class="intro-y col-span-12 overflow-auto lg:overflow-x-auto">
            @auth
            <form action="{{ route('delete-multiple-construction-river-bank') }}" method="POST" id="delete-multiple-form">
                @csrf
                @method('DELETE')
            ...
            <table class="mt-2 border-separate border-spacing-y-[10px] ">
                <thead class="text-gray-700 uppercase bg-blue-100">
                    <tr>
                        ...
                        <th class="sticky left-[40px] z-1 bg-blue-100 px-4 py-4 ">Tên công trình</th>
            ...
            <tbody>
                ...
                @foreach ($data as $key => $value)
                    <tr class="bg-white ">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap min-w-[160px]">{{ $value->influence_level }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap min-w-[160px]">{{ $value->capital_source }}</td>
                        ...
                        @auth
                        <td class="px-6 py-4 whitespace-nowrap min-w-[160px]"><div class="flex items-center justify-center">
                                <a class="mr-3 flex items-center text-blue-700"
                                 ...
                                 <a class="flex items-center text-red-600"
                                    onclick="openDeleteModal('{{ route('delete-construction-river-bank', ['id' => $value->id]) }}')"
