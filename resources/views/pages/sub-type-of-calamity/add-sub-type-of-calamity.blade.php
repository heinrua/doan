...
@section('subcontent')
    <h2 class="intro-y mt-5 text-lg font-medium uppercase flex items-center">
        {!! $icons['chevron-right'] !!}
        Loại Hình Thiên Tai Phụ
    </h2>
    <div class="mt-5 grid grid-cols-1 gap-x-6 pb-20"> 
        <div class="intro-y">
            <form enctype="multipart/form-data" class="validate-form" action="/create-sub-type-of-calamity" method="post">
                @csrf
                            ...
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <div class="w-full">
                                    <input name="name" id="name" type="text"
                                        placeholder="Tên Loại Hình Thiên Tai Phụ" />
                                    @error('name')
