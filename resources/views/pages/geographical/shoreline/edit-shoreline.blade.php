...
@section('subhead')
    <title>Cập Nhật Lịch Sử Bờ Đường - PCTT Cà Mau Dashboard</title>
@endsection

@section('subcontent')
    <h2 class="intro-y mt-5 text-lg font-medium uppercase flex items-center">
        {!! $icons['cloud-rain'] !!}
        Cập Nhật Lịch Sử Bờ Đường
    </h2>
    <div class="mt-5 grid grid-cols-1 gap-x-6 pb-20"> {{-- Chỉnh thành grid-cols-1 để tối ưu mobile --}}
        <div class="intro-y">
            <form enctype="multipart/form-data" class="validate-form" action="{{ route('update-shoreline') }}" method="post">
                ...
                <div class="intro-y box mt-5 p-5">
                    <div class="rounded-md border border-slate-200/60 p-5 dark:border-darkmode-400">
                        <div
                            ...
                            {!! $icons['chevron-down'] !!} Thông Tin Lịch Sử Đường Bờ
                        </div>
                        <div class="mt-5">
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <label class="md:w-80">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Tên đoạn đường bờ</div>
                                ...
                                <div class="w-full">
                                    <x-base.form-input name="name" id="name" type="text"
                                        value="{{ $data->name }}" placeholder="Tên đoạn đường bờ" />
                                    @error('name')
                            ...
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <div class="w-full">
                                    <x-base.form-input name="length" id="length" type="text"
                                        value="{{ $data->length }}" placeholder="Chiều dài (km)" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-5">
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <label class="md:w-80">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Chiều rộng (m)</div>
                                           <div class="ml-2 text-red-500 text-xl font-bold">*</div>
                                        </div>
                                    </div>
                                </label>
                                <div class="w-full">
                                    <x-base.form-input name="width" id="width" type="text"
                                        value="{{ $data->width }}" placeholder="Chiều rộng (m)" />
                                </div>
                            </div>
                        </div>
                        <div class="mt-5">
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <label class="md:w-80">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Toạ độ bắt đầu</div>
                                           <div class="ml-2 text-red-500 text-xl font-bold">*</div>
                                        </div>
                                ...
                                <div class="w-full">
                                    <x-base.form-input name="start_coordinates" id="start_coordinates" type="text"
                                        value="{{ $data->start_coordinates }}" placeholder="Toạ độ bắt đầu" />
                                </div>
                            </div>
                        </div>
                        <div class="mt-5">
                            <div class="flex-col md:flex-row items-start pt-5 first:mt-0 first:pt-0"
                                ...
                                <label class="md:w-80">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Toạ độ kết thúc</div>
                                           <div class="ml-2 text-red-500 text-xl font-bold">*</div>
                                        </div>
                                ...
                                <div class="w-full">
                                    <x-base.form-input name="end_coordinates" id="end_coordinates"
                                        value="{{ $data->end_coordinates }}" type="text"
                                        placeholder="Toạ độ kết thúc" />
                                </div>
                            </div>
                        </div>
                        <div class="mt-5">
