    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 mt-2 flex flex-wrap items-center sm:flex-nowrap">
         ...
         <div class="intro-y col-span-12 overflow-auto lg:overflow-x-auto">
            @auth
            <form action="{{ route('delete-multiple-cross-section') }}" method="POST" id="delete-multiple-form">
                @csrf
                @method('DELETE')
            ...
            <table class="mt-2 border-separate border-spacing-y-[10px]">
                <thead class="text-gray-700 uppercase bg-blue-100">
                    <tr>
                        ...
                        <th scope="col"class="px-6 py-4 whitespace-nowrap min-w-[160px]">Số hiệu</th>
                        <th scope="col"class="px-6 py-4 whitespace-nowrap min-w-[160px]">Thời gian cập nhật</th>
                        <th scope="col"class="px-6 py-4 whitespace-nowrap min-w-[160px]">Vị trí điểm đầu (X,Y)</th>
                        <th scope="col"class="px-6 py-4 whitespace-nowrap min-w-[160px]">Vị trí điểm cuối (X,Y)</th>
            ...
            <tbody>
                ...
                @foreach ($data as $key => $value)
                    <tr class="bg-white ">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap min-w-[160px]">{{ $value->reference_number }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap min-w-[160px]">
                            <div class="flex gap-3 text-center">
                                ...
                                <a class="flex items-center text-red-700" 
                                    onclick="openDeleteModal('{{ route('delete-cross-section', ['id' => $value->id, 'type' => 'cross-section']) }}')"
