...
<div class="mt-5 grid grid-cols-12 gap-6">
    <div class="intro-y col-span-12 flex flex-wrap items-start gap-3">
        ...
        @if ($userCurrent->is_master || $userCurrent->hasPermission('create-medical'))
        ...
        <table class="w-full min-w-[1500px] text-left text-gray-500 dark:text-gray-400">
            <thead class="text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-6 py-3">Tên địa điểm</th>
                ...
                @else
                    @foreach ($data as $key => $value)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">{{ $value->classify }}</td>
                            <td class="px-6 py-4">{{ $value->option }}</td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-3">
                                    <a href="/administrative/edit-medical/{{ $value->id }}" class="text-blue-700 flex items-center">
                                        {!! $icons['edit-2'] !!} Sửa
                                    </a>
                                    @if ($userCurrent->is_master || $userCurrent->hasPermission('delete-medical'))
